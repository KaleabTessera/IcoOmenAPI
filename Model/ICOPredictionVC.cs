...
public class Hit
{
    ...
    public List<string> _tech { get; set; }
    ...
    public List<double> price7Day { get; set; }
    public List<double> volume7Day { get; set; }
    public string objectID { get; set; }
    public HighlightResult _highlightResult { get; set; }
    public string slackUrl { get; set; }
    public User user { get; set; }
    public int? icoRaisedAmount { get; set; }
    public int? tokensIco { get; set; }
    public object tokensIssues { get; set; }
